...
public class ModelSensor extends ModelBase {
	...
	public ModelRenderer sensorBase = (new ModelRenderer(this, 0, 0))
	...
	public ModelSensor() {
		...
		this.sensorDishCenter = new ModelRenderer(this, 0, 24).setTextureSize(
				64, 64);
		this.sensorDishCenter.addBox(0, 0, 0, 7, 6, 1);
		this.sensorDishCenter.setRotationPoint(-3.0F, 4.0F, -0.5F);

		this.sensorDishLeft = new ModelRenderer(this, 32, 24).setTextureSize(
				64, 64);
		...
		this.sensorDishRight = new ModelRenderer(this, 48, 24).setTextureSize(
				64, 64);
	...
	public void renderIcon(int iconIndex) {
		...
		if (!sensorIcons.containsKey(iconIndex)) {
			currentIconRenderer = new ModelRenderer(this,
					16 * (iconIndex % 16),
					16 * ((int) Math.floor(iconIndex / 16.0F + 0.5F)))
