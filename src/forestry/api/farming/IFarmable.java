...
public interface IFarmable {
	...
	/**
	 * Plants a sapling by manipulating the world. The {@link IFarmLogic} should have verified the given location as valid. Called by the {@link IFarmHousing} which handles resources. 
	 * @param germling
	 * @param world
	 * @param x
	 * @param y
